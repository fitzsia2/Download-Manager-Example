...
import com.example.downloadmanagerexample.core.data.android.AndroidLocalFileDataSource
...
val coreModule = module {
    ...
    single<LocalFileDataSource> { AndroidLocalFileDataSource(androidContext()) }
